...
public class RobotClass {
    ...
    public static void moveRobot(RobotConnectionManager robotConnectionManager, int toX, int toY) {
        ...
        for (int i = 0; i < 3; i++) {
            try (RobotConnection robotConnection = robotConnectionManager.getConnection()) {
                robotConnection.moveRobotTo(1, 1);
                i = 3;
    ...
    static class RobotConnectionManager {
        RobotConnection getConnection() {
            System.out.println("attempt number: " + RobotClass.getI() + ". start RCM");
            if ((Test.getTest(0) instanceof Throwable) && (RobotClass.getI() == 1)) {
    ...
    static class RobotUse implements RobotConnection {
        ...
        public void moveRobotTo(int x, int y) {
            System.out.println("attempt number: " + RobotClass.getI() + ". start RC");
            if ((Test.getTest(1) instanceof Throwable) && (RobotClass.getI() == 1)) {
        ...
        @Override
        public void close() {
            System.out.println("attempt number: " + RobotClass.getI() + ". start close");
            if ((Test.getTest(2) instanceof Throwable) && (RobotClass.getI() == 1)) {
    ...
    static class Test {
        ...
        static RuntimeException getTest(int args) {
            ...
            return testArray[RobotClass.getRepeatNumber()][args];
        }
    }
}
